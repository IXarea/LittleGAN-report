...
\begin{figure}
    ...
    \end{minipage}
\end{figure}
Otherwise, we have done loads of experimental comparison about parameter initializer, learning rate, noise dimension, noise distribution, activation function, loss function, network layers, training method to get the better model structure, hyperparameters and training method.
...
The main components are the encoder and decoder, they are used in 3 networks.
