...
In the training aspect, we use the gradient penalty proposed in WGAN-GP\upcite{wgan-gp} and innovatively put forward The way of part training has basically achieved the research targets.
