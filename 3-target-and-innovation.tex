...
\item Propose a model based on GAN\upcite{gan} for conditional facial image generation and adjustment. Three tasks of facial image attribute recognition, conditional generation and conditional adjustment can be completed by one model. 
