...
Results also suggest that the use-cost of LittleGAN has declined. Compared to DCGAN and pix2pix,
    it can be more effectively applied to the actual production activity. 
