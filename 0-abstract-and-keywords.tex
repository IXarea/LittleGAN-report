...
As a result, our research tried to use and improve the developing Generative Adversarial Networks(GAN)\cite{gan},
...
Through a large scale of experiments, we propose "Single model for facial generation and adjustment",
    which is a multi-task model, able to achieve functions including facial attribute identification, 
...
Results also suggest that the use-cost of models have declined compared to DCGAN\upcite{dcgan} and pix2pix\upcite{pix2pix},
